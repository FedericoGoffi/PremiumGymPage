...
import styles from '../Components/payment_premium.module.css';
    ...
    <div className={styles.container}>
      ...
      <div className={styles.form}>
        <div className={styles.title}>
          <h2>
            <label className={styles.color_title}>PREMIUM</label>GYM
          </h2>
          <h3>
            You have selected the plan: <label className={styles.color_title}>PREMIUM</label>PLAN
          </h3>
